...
AGENT_MAX_TURN_RATE_DEG_PER_SECOND = 5400.0
AGENT_TURN_SATURATION_CONSTANT = 0.05

# --- MODIFIED: New speed calculation parameters ---
# This new global variable controls how dramatically the difference in
# power between the left and right signals translates into forward speed.
AGENT_SPEED_SCALING_FACTOR = 100.0

# REMOVED: The old speed constant is no longer used.
# AGENT_SPEED_CONSTANT = 0.5
